...
class Settings(BaseSettings):
    ...
    # Set it via environment variable GEMINI_API_KEY (required in production)
    # Do not commit API keys to version control - use .env file or environment variables
    GEMINI_API_KEY: str = Field(default="", description="Google Gemini API key for sports analysis (set via GEMINI_API_KEY env var)")
